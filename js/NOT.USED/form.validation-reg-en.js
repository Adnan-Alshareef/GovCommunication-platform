            ...
            function(event) {
                ...
                if (investorChoice === 'foreign') {
                    if (document.getElementById('file1')) {
                        document.getElementById('file1-error').innerHTML = "Please upload a file"
                    ...
                    if (document.getElementById('file2')) {
                        document.getElementById('file2-error').innerHTML = "Please upload a file"
                    ...
                    if (document.getElementById('file3')) {
                        document.getElementById('file3-error').innerHTML = "Please upload a file"
                    ...
                    if (document.getElementById('file4')) {
                        document.getElementById('file4-error').innerHTML = "Please upload a file"
                ...
                if (investorChoice === 'saudi') {
                    ...
                    if (document.getElementById('file5')) {
                        document.getElementById('file5-error').innerHTML = "Please upload a file"
                    ...
                    if (document.getElementById('file6')) {
                        document.getElementById('file6-error').innerHTML = "Please upload a file"
                    ...
                    if (document.getElementById('file7')) {
                        document.getElementById('file7-error').innerHTML = "Please upload a file"
                    ...
                    if (document.getElementById('file8')) {
                        document.getElementById('file8-error').innerHTML = "Please upload a file"
                ...
                if ($("[name='checkbox_select']:checked").length == 0) {
                    ...
                    failed = true;
                    document.getElementById('checkbox-error').innerHTML = "Please choose at least one service"
                ...
                const y = errors[0].getBoundingClientRect().top + window.pageYOffset + yOffset;
